function [data, axd, props] = data_pvelamp_slope( ftr, dimfun, data, formargs )
% peak velocity-amplitude slope
%
% [data, axd, props] = DATA_PVELAMP_SLOPE( ftr, dimfun, data, formargs )
%
% INPUT
...
% props : axes properties (cell)
	...
	[axd, props] = axes_();
		...
		% proceed data
	logger.progress( 'determine peak velocity-amplitude slope...' );
